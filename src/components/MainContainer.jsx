  ...
  <HomeContainer/>
    ...
    <section className='w-full my-6  mt-20  '>
      <div className='w-full flex items-center justify-between'>
        <p className='mt-5 md:mt-0 text-3xl font-semibold capitalize text-rose-500 relative
        ...
        <div className='hidden md:flex gap-3 items-center px-10'>
          <motion.div whileTap={{scale:0.5}}
            ...
            transition-all duration-100 ease-in-out hover:shadow-lg hover:border border-rose-700 flex items-center justify-center '>
                <MdChevronLeft onClick={()=>setScrollValue(-400)} className='text-3xl text-white hover:text-rose-600'/>
          </motion.div>
          <motion.div whileTap={{scale:0.5}}
            className='w-8 h-8 rounded-lg bg-greenGrass  cursor-pointer
            transition-all duration-100 ease-in-out hover:shadow-lg hover:border border-rose-700 flex items-center justify-center' >
                <MdChevronRight onClick={()=>setScrollValue(200)} className='text-3xl text-white hover:text-rose-600'/>
          </motion.div>
        </div>
      </div>
      <RowContainer 
